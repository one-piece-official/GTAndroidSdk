package com.gt.sdk.base.videocache.sourcestorage;
...
import com.gt.sdk.base.videocache.Preconditions;
import com.gt.sdk.base.videocache.SourceInfo;
...
class DatabaseSourceInfoStorage extends SQLiteOpenHelper implements SourceInfoStorage {
    ...
    private static final String CREATE_SQL = "CREATE TABLE " + TABLE + " (" + COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL," + COLUMN_URL + " TEXT NOT NULL," + COLUMN_MIME + " TEXT," + COLUMN_LENGTH + " INTEGER" + ");";
