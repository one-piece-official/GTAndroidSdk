...
import static com.gt.sdk.base.videocache.Preconditions.checkArgument;
...
class Pinger {
    ...
    boolean ping(int maxAttempts, int startTimeout) {
        ...
        while (attempts < maxAttempts) {
            try {
                ...
                SigmobLog.w("Error pinging server (attempt: " + attempts + ", timeout: " + timeout + "). ");
    ...
    private boolean pingServer() throws ProxyCacheException {
        ...
        Source source = ProxyUrlSource.getUrlSource(pingUrl);
        try {
            ...
            SigmobLog.i("Ping response: `" + new String(response) + "`, pinged? " + pingOk);
            return pingOk;
