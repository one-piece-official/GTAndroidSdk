...
import static com.gt.sdk.base.videocache.Preconditions.checkAllNotNull;
...
import com.gt.sdk.base.videocache.file.DiskUsage;
import com.gt.sdk.base.videocache.file.FileNameGenerator;
import com.gt.sdk.base.videocache.file.Md5FileNameGenerator;
import com.gt.sdk.base.videocache.file.TotalCountLruDiskUsage;
import com.gt.sdk.base.videocache.file.TotalSizeLruDiskUsage;
...
public class HttpProxyCacheServer {
    ...
    private final ExecutorService socketProcessor = ThreadPoolFactory.getFixIOExecutor();
    ...
    private HttpProxyCacheServer(Config config) {
        ...
        try {
            inetAddress = InetAddress.getByName(PROXY_HOST);
            ...
            SigmobLog.i("Proxy cache server started. Is it alive? " + isAlive());
...
//                SigmobLog.d("Accept new socket " + socket);
    ...
    private void processSocket(Socket socket) {
        try {
            ...
            SigmobLog.d("Request to cache proxy:" + request);
            ...
            SigmobLog.d("Opened connections: " + getClientsCount());
        }
    }
...
//            SigmobLog.e("Failed to close socket on proxy side  It seems client have already closed connection.", e);
        }
    }
...
//            onError(new ProxyCacheException("Error closing socket", e));
    ...
    public static final class Builder {
         ...
         * '/SigmobAndroid/data/[app_package_name]/cache/video-cache/' if card is mounted and app has appropriate permission
