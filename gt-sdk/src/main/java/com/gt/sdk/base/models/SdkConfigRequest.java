...
public final class SdkConfigRequest extends AndroidMessage<SdkConfigRequest, SdkConfigRequest.Builder> {
     ...
     * 必填！应用信息
     */
    @WireField(tag = 1, adapter = "com.gt.sdk.base.models.App#ADAPTER")
    public final App app;

    /**
     * 必填！设备信息
     */
    @WireField(tag = 2, adapter = "com.gt.sdk.base.models.Device#ADAPTER")
    public final Device device;

    /**
     * 用户信息
     */
    @WireField(tag = 5, adapter = "com.gt.sdk.base.models.User#ADAPTER")
