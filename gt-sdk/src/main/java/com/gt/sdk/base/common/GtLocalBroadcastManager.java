...
public class GtLocalBroadcastManager {

    static final int MSG_EXEC_PENDING_BROADCASTS = 1;
    private static final String TAG = "LocalBroadcastManager";
    private static final boolean DEBUG = false;
    private static final Object mLock = new Object();
    private static GtLocalBroadcastManager mInstance;
    ...
    private GtLocalBroadcastManager(Context context) {
        mAppContext = context;
    ...
    public static GtLocalBroadcastManager getInstance(Context context) {
        synchronized (mLock) {
            if (mInstance == null) {
                mInstance = new GtLocalBroadcastManager(context.getApplicationContext());
            }
            return mInstance;
        }
    }
