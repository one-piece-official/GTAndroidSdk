...
public final class SplashConfig extends AndroidMessage<SplashConfig, SplashConfig.Builder> {
    ...
    public SplashConfig(Integer cacheTop, Integer ad_load_timeout) {
        this(cacheTop, ad_load_timeout, ByteString.EMPTY);
    }

    public SplashConfig(Integer cacheTop, Integer ad_load_timeout, ByteString unknownFields) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SplashConfig)) return false;
        SplashConfig o = (SplashConfig) other;
    ...
    public String toString() {
        ...
        return builder.replace(0, 2, "SplashConfig{").append('}').toString();
    }
    ...
    public static final class Builder extends Message.Builder<SplashConfig, Builder> {
        ...
        public SplashConfig build() {
            return new SplashConfig(cacheTop, ad_load_timeout, super.buildUnknownFields());
        }
    }
    ...
    private static final class ProtoAdapter_SplashConfig extends ProtoAdapter<SplashConfig> {
        ...
        @Override
        public int encodedSize(SplashConfig value) {
        ...
        @Override
        public void encode(ProtoWriter writer, SplashConfig value) throws IOException {
        ...
        @Override
        public SplashConfig decode(ProtoReader reader) throws IOException {
            Builder builder = new Builder();
        ...
        @Override
        public SplashConfig redact(SplashConfig value) {
