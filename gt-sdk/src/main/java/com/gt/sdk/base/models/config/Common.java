...
public final class Common extends AndroidMessage<Common, Common.Builder> {
     ...
     * api配置
     */
    @WireField(tag = 12, adapter = "com.gt.sdk.base.models.config.UrlConfig#ADAPTER")
    public final UrlConfig urlConfig;

    /**
     * 激励视频配置
     */
    @WireField(tag = 13, adapter = "com.gt.sdk.base.models.config.RvConfig#ADAPTER")
    public final RvConfig rv_config;

    /**
     * 开屏配置
     */
    @WireField(tag = 14, adapter = "com.gt.sdk.base.models.config.SplashConfig#ADAPTER")
    public final SplashConfig splash_config;

    @WireField(tag = 15, adapter = "com.gt.sdk.base.models.config.NativeConfig#ADAPTER")
