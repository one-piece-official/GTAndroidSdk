...
public final class RvConfig extends AndroidMessage<RvConfig, RvConfig.Builder> {

    public static final ProtoAdapter<RvConfig> ADAPTER = new ProtoAdapter_RvConfig();
    ...
    public RvConfig(Integer cacheTop, Integer ad_load_timeout) {
        this(cacheTop, ad_load_timeout, ByteString.EMPTY);
    }

    public RvConfig(Integer cacheTop, Integer ad_load_timeout, ByteString unknownFields) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof RvConfig)) return false;
        RvConfig o = (RvConfig) other;
    ...
    public String toString() {
        ...
        return builder.replace(0, 2, "RvConfig{").append('}').toString();
    }
    ...
    public static final class Builder extends Message.Builder<RvConfig, Builder> {
        ...
        public RvConfig build() {
            return new RvConfig(cacheTop, ad_load_timeout, super.buildUnknownFields());
        }
    }
    ...
    private static final class ProtoAdapter_RvConfig extends ProtoAdapter<RvConfig> {
        ...
        @Override
        public int encodedSize(RvConfig value) {
            return ProtoAdapter.UINT32.encodedSizeWithTag(1, value.cacheTop) + ProtoAdapter.UINT32.encodedSizeWithTag(2, value.ad_load_timeout) + value.unknownFields().size();
        }

        @Override
        public void encode(ProtoWriter writer, RvConfig value) throws IOException {
        ...
        @Override
        public RvConfig decode(ProtoReader reader) throws IOException {
            Builder builder = new Builder();
        ...
        @Override
        public RvConfig redact(RvConfig value) {
