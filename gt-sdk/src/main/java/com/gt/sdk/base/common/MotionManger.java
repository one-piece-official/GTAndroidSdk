...
public class MotionManger {
    ...
    public enum OrientationMotionType {
        SWING, WRING, SLOPE
    }

    public abstract static class Motion {
        ...
        public abstract void setRawSensitivity(int sensitivity_raw);

    }

    public static class ShakeMotion extends Motion implements SensorEventListener {
        private static float sensitivity = 3.0f;
        private static final long TIME_INTERVAL = 2000; // 2 seconds in milliseconds
        ...
        public ShakeMotion(Context context, MotionListener listener) {
            mListener = listener;
        ...
        public void setRawSensitivity(int sensitivity) {
            this.rawSensitivity = sensitivity;
        }
...
//            }
        ...
        private void handleGyroData(float[] rotationRate) {
            ...
            if (magnitude > sensitivity && !isShaking && interval) {
                ...
                z_max_acc = 0;
                if (mListener != null) {
                    mListener.onMotionEnd(map);
                }
            }
        }
    }

    public static class OrientationMotion extends Motion implements SensorEventListener {
        private final SensorManager mSensorManager;
        ...
        private OrientationMotionType type;
        ...
        public OrientationMotion(Context context, MotionListener motionListener, OrientationMotionType type) {
