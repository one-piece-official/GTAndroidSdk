...
public class OkHttp3UrlSource implements Source {
    ...
    public void close() throws ProxyCacheException {
        try {
            ...
            String message = "Wait... but why? WTF!? " + "If you read it on your device log, please";
...
//            ProxyCacheUtils.close(inputStream);
    ...
    private Response openConnection(long offset, int timeout) throws IOException, ProxyCacheException {
        ...
        if (client == null) {
            client = new OkHttpClient().newBuilder().connectionPool(new ConnectionPool()).connectTimeout(10000, TimeUnit.MILLISECONDS).readTimeout(10000, TimeUnit.MILLISECONDS).writeTimeout(10000, TimeUnit.MILLISECONDS).build();
        }
