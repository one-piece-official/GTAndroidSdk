...
//        showNormalLayout();
        ...
        CONTAINER_LIST.getLast().addView(videoContainer, new FrameLayout.LayoutParams(
...
//                && CURRENT_JZVD != null
                && getVideoAdView().state == STATE_PLAYING
                && getVideoAdView().screen == SCREEN_FULLSCREEN) {
    ...
    public void setUIStyle(SigAdStyle style) {
        ...
        switch (style) {
            case PREVIEW: {
                ...
                if (mAppView != null && (getVideoAdView().state == STATE_AUTO_COMPLETE
                        || getVideoAdView().state == STATE_ERROR)) {
