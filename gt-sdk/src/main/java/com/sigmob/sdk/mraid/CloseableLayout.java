...
public class CloseableLayout extends FrameLayout {
    ...
    // same pattern used in the SigmobAndroid framework to handle click events.
...
//                INTERSTITIAL_CLOSE_BUTTON_NORMAL.createDrawable(context));
    ...
    /**
     * This is a copy of the UnsetPressedState pattern from SigmobAndroid's View.java, which is used
