...
public class SigmobRes {
    ...
    public static int getSig_custom_download_dialog() {
        ...
        String stlyeName = mScreenWidth>mScreenHeight?SigmobRes.sig_custom_fullscreen_dialog:SigmobRes.sig_custom_dialog;

        return ClientMetadata.getInstance().getStyleResources(stlyeName);
    }
