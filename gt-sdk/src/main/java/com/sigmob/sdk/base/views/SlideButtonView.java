...
//                invalidate();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setTextSize(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,
                16 * scale, getResources().getDisplayMetrics()));
        ...
        if (!TextUtils.isEmpty(title)) {
            ...
            textPaint.setTextSize(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,
                    20, getResources().getDisplayMetrics())); // Adjust text size as needed
        ...
        if (!TextUtils.isEmpty(desc)) {
            textPaint.setTextSize(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,
                    16, getResources().getDisplayMetrics())); // Adjust text size as needed
    ...
    private void initGradient() {
        ...
        LinearGradient gradient = new LinearGradient(0, h, w, 0,
                new int[]{
                        colorWithAlpha(Color.WHITE, 0.2f),
                        colorWithAlpha(Color.WHITE, 0.5f),
                        colorWithAlpha(Color.WHITE, 0.2f)
                },
                new float[]{0.2f, 0.8f, 1f},
