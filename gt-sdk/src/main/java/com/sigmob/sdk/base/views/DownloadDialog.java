    ...
    public BaseWebView getAdView() {
        ...
        if (mAdUnit != null) {
            ...
            if (material != null && material.ad_privacy != null) {
                AdPrivacy ad_privacy = material.ad_privacy;
//                if (!TextUtils.isEmpty(ad_privacy.privacy_info_url)) {
//                    htmlUrl = ad_privacy.privacy_info_url;
//                }

                if (ad_privacy.privacy_template_info != null && ad_privacy.privacy_template_info.size() > 0) {
                    privacyMap = ad_privacy.privacy_template_info;
                }

                if (!TextUtils.isEmpty(ad_privacy.privacy_template_url)) {
                    String fileName = Md5Util.md5(ad_privacy.privacy_template_url);
                    htmlFile = new File(SigmobFileUtil.getSigHtmlDir(SigmobFileUtil.SigHtmlPrivacyDir), fileName + ".html");
                }
            } else {
            ...
            public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
                ...
                switch (level){
                    case ERROR:{
                        ...
                        PointEntitySigmobUtils.SigmobError("h5_error","download_dialog",0,consoleMessage.message(),null,null,mAdUnit,null);
                    }break;
                }
                return false;
            }
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public WebResourceResponse shouldInterceptRequest(final WebView view, final WebResourceRequest request) {
                ...
                try {
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                        webResourceResponse = SigmobWebViewClient.injectionSigmobHtmlResponse(request.getUrl());
                    }
            ...
            public WebResourceResponse shouldInterceptRequest(final WebView view, final String url) {
                ...
                try {
                    ...
                    WebResourceResponse webResourceResponse = SigmobWebViewClient.injectionSigmobHtmlResponse(Uri.parse(url));
                    return webResourceResponse;
                } catch (Throwable th) {
...
//                return false;//系统自己处理
            ...
            public void onReceivedHttpError(WebView view, WebResourceRequest request, WebResourceResponse errorResponse) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    PointEntitySigmobUtils.SigmobError("h5_error","download_dialog",0,request.getUrl()+" error:" +errorResponse.getStatusCode(),null,null,mAdUnit,null);
                }
            }
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                PointEntitySigmobUtils.SigmobError("h5_error","download_dialog",0,failingUrl+" error:" +description,null,null,mAdUnit,null);
            ...
            public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        PointEntitySigmobUtils.SigmobError("h5_error","download_dialog",0,request.getUrl()+" error:" +error.getDescription(),null,null,mAdUnit,null);
                    }
                }
        ...
        if (!TextUtils.isEmpty(htmlUrl)) {
            ...
            mWebView.loadUrl(WindConstants.SIGMOBHTML + "://" + htmlFile.getAbsolutePath());
        } else {
            isRenderSuccess = false;
        }
