...
public class SplashViewAbilitySessionManager implements SessionManager {

    private final HashSet<SplashAdViewAbilitySession> mViewAbilitySessions;
    ...
    public SplashViewAbilitySessionManager() {
        mViewAbilitySessions = new HashSet<>();
        mViewAbilitySessions.add(new SplashAdViewAbilitySession());
    }
    ...
    public void createDisplaySession(BaseAdUnit adUnit) {
        ...
        for (final SplashAdViewAbilitySession session : mViewAbilitySessions) {
