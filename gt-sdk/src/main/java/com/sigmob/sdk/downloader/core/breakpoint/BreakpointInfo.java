...
public class BreakpointInfo {
    ...
    public BreakpointInfo(int id, String url, File parentFile,
                          String filename) {
        this.id = id;
        this.url = url;
    ...
    BreakpointInfo(int id, String url, File parentFile,
                   String filename, boolean taskOnlyProvidedParentPath) {
        this.id = id;
        this.url = url;
        this.parentFile = parentFile;
        this.blockInfoList = new ArrayList<>();
