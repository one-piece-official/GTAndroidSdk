...
public class NativeAdUnifiedListActivity extends Activity {
    ...
    private void loadListAd() {
        ...
        if (windNativeUnifiedAd == null) {
            windNativeUnifiedAd = new WindNativeUnifiedAd(new WindNativeAdRequest(placementId, String.valueOf(userID), options));
        }
    ...
    private static class MyAdapter extends BaseAdapter {
        ...
        private View getUnifiedADView(View convertView, ViewGroup viewGroup, final WindNativeAdData ad) {
