...
//                    handler.sendMessageDelayed(message, 3000);
    ...
    private void loadAd(String placementId) {
        ...
        WindNewInterstitialAdRequest adRequest = new WindNewInterstitialAdRequest(placementId, Constants.user_id, options);
        ...
        if (interstitialAd != null) {
            if (isNewInstance) {
                ...
                interstitialAd = new WindNewInterstitialAd(adRequest);
