...
import com.xmlywind.windad.natives.NativeADEventListener;
import com.xmlywind.windad.natives.NativeAdPatternType;
import com.xmlywind.windad.natives.WindNativeAdRender;
...
public class NativeAdDemoRenameRender implements WindNativeAdRender<NativeADData> {
...
//        clickableViews.add(mDownloadButton);
        ...
        adData.bindViewForInteraction(context, view, clickableViews, creativeViewList, img_dislike, new NativeADEventListener() {
            @Override
