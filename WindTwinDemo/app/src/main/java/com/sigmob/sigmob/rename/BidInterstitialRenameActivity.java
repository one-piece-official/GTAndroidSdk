...
import com.xmlywind.windad.bidding.WindBiddingInterstitialAd;
...
import static com.sigmob.sigmob.Constants.CONF_BID_TOKEN;

public class BidInterstitialRenameActivity extends AppCompatActivity implements WindInterstitialAdListener {
    ...
    private WindBiddingInterstitialAd windInterstitialAd1;
    private WindBiddingInterstitialAd windInterstitialAd2;
            ...
            switch (msg.what) {
                case 0x001:
                    if (windInterstitialAd1 != null) {
                        windInterstitialAd1.loadAd(bidToken);
                    }
//                    handler.sendEmptyMessageDelayed(0x002, 3000);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bid_interstitial_rename);
        ...
        windInterstitialAd2 = new WindBiddingInterstitialAd(this, new WindInterstitialAdRequest(placementId4, String.valueOf(userID), null));
        windInterstitialAd2.setWindInterstitialAdListener(this);

        windInterstitialAd1 = new WindBiddingInterstitialAd(this, new WindInterstitialAdRequest(placementId3, String.valueOf(userID), null));
        windInterstitialAd1.setWindInterstitialAdListener(new WindInterstitialAdListener() {
            ...
            public void onInterstitialAdLoadSuccess(final String placementId) {
                BidInterstitialRenameActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
...
//                handler.sendEmptyMessage(0x001);
        ...
        switch (view.getId()) {
            ...
            case R.id.loadAd_button2:
                if (windInterstitialAd2 != null) {
                    windInterstitialAd2.loadAd(bidToken);
                }
                break;
    ...
    private void updatePlacement() {
        ...
        bidToken = sharedPreferences.getString(CONF_BID_TOKEN, "");
    ...
    private void playAd() {
        ...
        option.put(com.sigmob.windad.WindAds.AD_SCENE, "menu_1");
