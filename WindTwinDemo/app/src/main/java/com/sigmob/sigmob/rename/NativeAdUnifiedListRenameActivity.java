...
public class NativeAdUnifiedListRenameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_native_ad_unified_list_rename);
        updatePlacement();
        initListView();
    }
    ...
    private void loadListAd() {
        ...
        windNativeUnifiedAd.loadAd(new WindNativeUnifiedAd.NativeAdLoadListener() {
            ...
            public void onError(WindAdError error, String placementId) {
                ...
                Toast.makeText(NativeAdUnifiedListRenameActivity.this, "onError:" + error.toString(), Toast.LENGTH_SHORT).show();
                if (mListView != null) {
