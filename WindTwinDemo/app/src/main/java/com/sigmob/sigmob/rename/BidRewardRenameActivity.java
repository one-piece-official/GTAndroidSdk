...
import com.xmlywind.windad.bidding.WindBiddingRewardedAd;
...
public class BidRewardRenameActivity extends AppCompatActivity implements WindRewardedVideoAdListener {
    ...
    private WindBiddingRewardedAd windRewardedVideoAd1;
    private WindBiddingRewardedAd windRewardedVideoAd2;
            ...
            switch (msg.what) {
                case 0x001:
                    if (windRewardedVideoAd1 != null) {
                        windRewardedVideoAd1.loadAd(bidToken);
                    }
//                    handler.sendEmptyMessageDelayed(0x002, 3000);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bid_reward_rename);
        ...
        windRewardedVideoAd1 = new WindBiddingRewardedAd(this, new WindRewardAdRequest(placementId, String.valueOf(userID), null));
        windRewardedVideoAd1.setWindRewardedVideoAdListener(new WindRewardedVideoAdListener() {
            ...
            public void onVideoAdLoadSuccess(final String placementId) {
                BidRewardRenameActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
...
//                }
                ...
                windRewardedVideoAd2 = new WindBiddingRewardedAd(this, new WindRewardAdRequest(placementId2, String.valueOf(userID), options));
                windRewardedVideoAd2.setWindRewardedVideoAdListener(this);
                windRewardedVideoAd2.loadAd(bidToken);
                break;
