...
public class BidInterstitialActivity extends AppCompatActivity implements WindInterstitialAdListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        windInterstitialAd1.setWindInterstitialAdListener(new WindInterstitialAdListener() {
            ...
            public void onInterstitialAdLoadSuccess(final String placementId) {
                BidInterstitialActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
