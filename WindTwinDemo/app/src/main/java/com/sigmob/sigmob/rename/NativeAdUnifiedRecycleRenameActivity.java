...
public class NativeAdUnifiedRecycleRenameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_native_ad_unified_recycle_name);
        updatePlacement();
        initListView();
    }
    ...
    private void loadListAd() {
        ...
        windNativeUnifiedAd.loadAd(new WindNativeUnifiedAd.NativeAdLoadListener() {
            ...
            public void onError(WindAdError error, String placementId) {
                ...
                Toast.makeText(NativeAdUnifiedRecycleRenameActivity.this, "onError:" + error.toString(), Toast.LENGTH_SHORT).show();
                if (mListView != null) {
    ...
    private static class MyAdapter extends RecyclerView.Adapter {
        ...
        private static class AdViewHolder extends RecyclerView.ViewHolder {
            ...
            //媒体自渲染的View
            NativeAdDemoRenameRender adRender;
            ...
            public AdViewHolder(View itemView) {
                ...
                adRender = new NativeAdDemoRenameRender();
            }
        }
