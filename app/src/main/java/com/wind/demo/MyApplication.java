...
import static com.wind.demo.ConfigurationFragment.SIGDEMO_CONF_URL;
...
//                .build();
    ...
    private void initSDK() {
        ...
        switch (config_url) {
            ...
            case 1: {
                if (extData != null) {
                    extData.put(SIGDEMO_CONF_URL, ConfigurationFragment.CONFIG_URL_NORMAL);
                }
            }
            break;
            case 2: {
                if (extData != null) {
                    extData.put(SIGDEMO_CONF_URL, ConfigurationFragment.CONFIG_URL_TEST);
                }
            }
            break;
            case 3: {
                if (extData != null) {
                    extData.put(SIGDEMO_CONF_URL, ConfigurationFragment.CONFIG_URL_MOCK);
                }
            }
            break;
