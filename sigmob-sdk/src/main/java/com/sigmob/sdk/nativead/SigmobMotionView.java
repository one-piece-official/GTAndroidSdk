...
import com.sigmob.sdk.base.common.SingleMotionManger;
...
public class SigmobMotionView extends RelativeLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private ClickCommon mClickCommon;
    ...
    public boolean initWidgetView(int widgetId, int sensitivity, ClickCommon clickCommon) {

        mClickCommon = clickCommon;
        switch (widgetId) {
            case 138757: {
...
//                }
        ...
        if (mWidgetView != null) {
            mClickCommon.widget_id = widgetId;
        ...
        motion = new SingleMotionManger.Motion(getContext(), new SingleMotionManger.MotionListener() {
            ...
            public void onMotionEnd(Map<String, Number> info) {
                if (info != null) {
                    ...
                    if (turn_x != null) {
                        mClickCommon.turn_x = String.valueOf(turn_x.intValue());
                    }
                    if (turn_y != null) {
                        mClickCommon.turn_y = String.valueOf(turn_y.intValue());
                    }
                    if (turn_z != null) {
                        mClickCommon.turn_z = String.valueOf(turn_z.intValue());
                    }
                    mClickCommon.turn_time = String.valueOf(turn_time);
    ...
    private void addShakeView(int sensitivity) {
        ...
        motion = new SingleMotionManger.Motion(getContext(), new SingleMotionManger.MotionListener() {
            ...
            public void onMotionEnd(Map<String, Number> info) {
                ...
                if (x_max_acc != null && mClickCommon != null) {
                   mClickCommon.x_max_acc = String.valueOf(x_max_acc.intValue());
                }
                if (y_max_acc != null && mClickCommon != null) {
                    mClickCommon.y_max_acc = String.valueOf(y_max_acc.intValue());
                }
                if (z_max_acc != null && mClickCommon != null) {
                    mClickCommon.z_max_acc = String.valueOf(z_max_acc.intValue());
                }
                mWidgetView.postDelayed(new Runnable() {
                    @Override
                    public void run() {
