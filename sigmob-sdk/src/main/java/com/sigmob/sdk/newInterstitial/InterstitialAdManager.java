...
public class InterstitialAdManager implements NewInterstitial.InterstitialListener,
    ...
    private NewInterstitial interstitial;
    private WindAdShowListener mWindAdShowListener;
    private String preLoadRequestId;
    ...
    private NewInterstitial showAdCheck() {
    ...
    public void show(final LoadAdRequest loadAdRequest, WindAdShowListener windAdShowListener) {
        ...
        NewInterstitial interstitial = showAdCheck();
    ...
    void loadAd(LoadAdRequest request) {
        ...
        if (interstitial == null) {
            interstitial = new NewInterstitial(this) {
            };
        }
...
//        SigmobLog.d("adsRequest loadAdRequest = [" + loadAdRequest + "], placementId = [" + mPlacementId + "]");
    ...
    public void onInterstitialDismissed(BaseAdUnit adUnit) {
        ...
        if (mAdStatus == AdStatus.AdStatusClose) return;
...
//                    notifyPreLoadSuccess();
    ...
    @Override
    public void onAdShowFail(BaseAdUnit adUnit, String message) {
