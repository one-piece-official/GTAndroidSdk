...
public class WindInterstitialAd extends WindBaseAd {

    private InterstitialAdManager mAd;
    private InterstitialAdManager mPreloadAd;
...
//            PointEntitySigmobUtils.SigmobRequestTracking(PointCategory.SHOW, PointCategory.INIT, mRequest, loadAdRequest,null);
            ...
            mAd.show(loadAdRequest, new WindAdShowListener() {
                ...
                public void onVideoAdPlayComplete(final String placementId) {
                    ...
                    mHandler.post(new Runnable() {
                        ...
                        public void run() {
                            if (windAdShowListener != null) {
                                SigmobLog.i("onVideoAdPlayComplete " + placementId);
        ...
        try {
            ...
            if (mADStatus == AdStatus.AdStatusPlaying) {
                if (mPreloadAd != null) {
                    ...
                    mPreloadAd = new InterstitialAdManager();
            ...
            windError.commit();
            if (mWindAdLoadListener != null) {
                SigmobLog.i("onVideoAdLoadError " + "|" + getPlacementId() + "|" + mADStatus+"|"+e.getMessage());
