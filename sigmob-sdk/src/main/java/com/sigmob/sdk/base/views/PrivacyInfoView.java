...
public class PrivacyInfoView extends LinearLayout {
    ...
    public PrivacyInfoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PrivacyInfoView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    private void init(Context context) {
        View view = inflate(context, ResourceUtil.getLayoutId(context, "sig_ad_privacy_new_layout"), this);
