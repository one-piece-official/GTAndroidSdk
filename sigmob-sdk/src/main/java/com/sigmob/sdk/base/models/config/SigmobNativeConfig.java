 ...
 * 激励视频相关接口地址
 */
public final class SigmobNativeConfig extends AndroidMessage<SigmobNativeConfig, SigmobNativeConfig.Builder> {
    public static final ProtoAdapter<SigmobNativeConfig> ADAPTER = new ProtoAdapter_SigmobNativeConfig();

    public static final Parcelable.Creator<SigmobNativeConfig> CREATOR = AndroidMessage.newCreator(ADAPTER);
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SigmobNativeConfig)) return false;
        SigmobNativeConfig o = (SigmobNativeConfig) other;
    ...
    public String toString() {
        ...
        return builder.replace(0, 2, "SigmobNativeConfig{").append('}').toString();
    }
    ...
    public static final class Builder extends Message.Builder<SigmobNativeConfig, Builder> {
        ...
        public SigmobNativeConfig build() {
            return new SigmobNativeConfig(cacheTop, ad_load_timeout, super.buildUnknownFields());
        }
    }
