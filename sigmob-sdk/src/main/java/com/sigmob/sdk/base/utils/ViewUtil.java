...
import com.sigmob.sdk.nativead.SigNativeAdVideo;
...
public class ViewUtil {
    ...
    public static void observerLayout(View view, Runnable runnable) {
    ...
    public  interface OnViewTouchListener {
         boolean onViewTouch(View view, MotionEvent down,MotionEvent up);
    }
    ...
    public class ViewTouchListener implements View.OnTouchListener{
        ...
        ViewTouchListener(OnViewTouchListener onViewTouchListener){
        ...
        public boolean onTouch(View view, MotionEvent event) {
            ...
            if(event.getAction() == MotionEvent.ACTION_DOWN){
                ...
                if(onViewTouchListener != null){
                    onViewTouchListener.onViewTouch(view,down,event);
                }
            }
            return false;
        }
    ...
    public static boolean isPointInView(final View view, MotionEvent ev) {
        if (view == null) {
            return false;
        }
        //控件自身左上角的X坐标
