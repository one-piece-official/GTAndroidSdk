...
public abstract class BaseBroadcastReceiver extends BroadcastReceiver {
    ...
    public static void broadcastAction(final Context context, final String broadcastIdentifier,
                                       final Map<String, Object> extras, final String action) {
    ...
    public static void broadcastAction(final Context context, final String broadcastIdentifier,
        ...
        SigMobLocalBroadcastManager localBroadcastManager = SigMobLocalBroadcastManager.getInstance(context);
    ...
    public void register(final BroadcastReceiver broadcastReceiver) {
        SigMobLocalBroadcastManager localBroadcastManager = SigMobLocalBroadcastManager.getInstance(SDKContext.getApplicationContext());
        if (localBroadcastManager != null) {
            try {
    ...
    public void unregister(final BroadcastReceiver broadcastReceiver) {
        if (broadcastReceiver != null) {
            SigMobLocalBroadcastManager localBroadcastManager =
                    SigMobLocalBroadcastManager.getInstance(SDKContext.getApplicationContext());
            if (localBroadcastManager != null) {
                try {
