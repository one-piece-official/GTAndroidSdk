...
import static com.sigmob.sdk.base.models.SigMacroCommon._CLICKID_;
...
//            }
    ...
    public void handleUrlAction(final ClickUIType clickUIType, final String url,
                                final String coordinate,
                                final boolean isRecord,
                                final boolean showAppElement) {
        ...
        UrlHandler urlHandler = new UrlHandler.Builder()
                ...
                .withAdunit(getBaseAdUnit())
                .withoutSigmobBrowser(getBaseAdUnit().isSkipSigmobBrowser())
                .withoutResolvedUrl(getBaseAdUnit().getAd().forbiden_parse_landingpage)
                .build();
