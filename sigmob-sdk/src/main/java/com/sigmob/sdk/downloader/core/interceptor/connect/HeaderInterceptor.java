...
import static com.sigmob.sdk.downloader.core.Util.USER_AGENT;
...
public class HeaderInterceptor implements Interceptor.Connect {
    ...
    public DownloadConnection.Connected interceptConnect(DownloadChain chain) throws IOException {
        ...
        FileDownload.with().callbackDispatcher().dispatch().connectEnd(task, blockIndex,
                connected.getResponseCode(), responseHeaderFields);

        // if precondition failed.
        final DownloadStrategy strategy = FileDownload.with().downloadStrategy();
