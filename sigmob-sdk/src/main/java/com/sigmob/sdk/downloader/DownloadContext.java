...
import com.sigmob.sdk.downloader.core.listener.DownloadListener2;
import com.sigmob.sdk.downloader.core.listener.DownloadListenerBunch;
...
public class DownloadContext {
    ...
    private static final Executor SERIAL_EXECUTOR = new ThreadPoolExecutor(0,
            ...
            Util.threadFactory("FileDownload Serial", false));
    ...
    DownloadContext(DownloadTask[] tasks,
                    DownloadContextListener contextListener,
                    QueueSet set,
                    Handler uiHandler) {
...
//            justification = "user must know change this array will effect internal job")
    ...
    public void stop() {
        if (started) FileDownload.with().downloadDispatcher().cancel(tasks);
        started = false;
    }
    ...
    static class QueueAttachListener extends DownloadListener2 {
        ...
        QueueAttachListener(DownloadContext context,
                            DownloadContextListener contextListener, int taskCount) {
