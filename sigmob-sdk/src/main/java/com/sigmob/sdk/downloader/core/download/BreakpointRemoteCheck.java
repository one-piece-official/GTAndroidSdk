...
import static com.sigmob.sdk.downloader.core.Util.RANGE_NOT_SATISFIABLE;
...
import com.sigmob.sdk.downloader.core.exception.FileBusyAfterRunException;
...
public class BreakpointRemoteCheck {
    ...
    public BreakpointRemoteCheck(DownloadTask task,
                                 BreakpointInfo info) {
        this.task = task;
        this.info = info;
    }
    ...
    public void check() throws IOException {
        // local etag
        final DownloadStrategy downloadStrategy = FileDownload.with().downloadStrategy();
        ...
        if (FileDownload.with().downloadDispatcher().isFileConflictAfterRun(task)) {
