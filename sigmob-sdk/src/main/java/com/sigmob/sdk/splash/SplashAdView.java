...
//        urlHandler.setDelay_millis(0);
    ...
    private void addTipView() {
        ...
        RelativeLayout.LayoutParams ll = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, height);
    ...
    private void addSkipView() {
        ...
        RelativeLayout.LayoutParams ll = new RelativeLayout.LayoutParams(width, height);
    ...
    private void addScaleButtonView() {
        ...
        RelativeLayout.LayoutParams ll = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, size);
        ll.addRule(CENTER_HORIZONTAL);
        ll.addRule(ALIGN_PARENT_BOTTOM);
    ...
    private void addBeatheView() {
        ...
        RelativeLayout.LayoutParams ll2 = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
